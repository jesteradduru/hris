<template>
  <AuthenticatedLayout>
    ...
    <button v-if="permission.includes('Add L&D Form')" class="btn btn-primary" data-bs-target="#uploadSpmsForm" data-bs-toggle="modal">UPLOAD DOCUMENT</button>
...
const onSubmit = () => form.post(route('lnd_forms.store'), {
  onSuccess: () => {
    form.reset()
    form.file = null
  },
...
const confirm = () => window.confirm('Are you sure to delte this document?')
